...
public class DingCallbackCrypto {
     ...
     *                       第三方企业应用, 使用suiteKey
     *
     * @throws com.aliyun.dingtalk.util.DingCallbackCrypto.DingTalkEncryptException 执行失败，请查看该异常的错误码和具体的错误信息
     */
     ...
     * @param nonce     随机字符串
     * @return
     * @throws com.aliyun.dingtalk.util.DingCallbackCrypto.DingTalkEncryptException
     */
