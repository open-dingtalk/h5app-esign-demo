...
public class DingTalkUserController {
     ...
     */
    @GetMapping("/login")
    public ServiceResult login(@RequestParam String corpId, @RequestParam(value = "authCode") String authCode) {

        return ServiceResult.getSuccessResult(dingTalkUserService.getUserInfo(corpId, authCode));
